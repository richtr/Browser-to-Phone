...
public class DeviceInfo {
    ...
    @Persistent
    private Boolean phoneToBrowserExperimentEnabled;
    ...
    public boolean getPhoneToBrowserExperimentEnabled() {
        return (phoneToBrowserExperimentEnabled != null ?
                phoneToBrowserExperimentEnabled.booleanValue() : false);
    }

    public void setPhoneToBrowserExperimentEnabled(boolean phoneToBrowserExperimentEnabled) {
        this.phoneToBrowserExperimentEnabled = new Boolean(phoneToBrowserExperimentEnabled);
    }
